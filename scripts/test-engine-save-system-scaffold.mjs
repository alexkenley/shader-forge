...
assert.match(saveSource, /slotNameFromFileName/);
assert.match(saveSource, /listSlots/);
...
assert.match(runtimeApp, /cycleRuntimeSaveSlot/);
assert.match(runtimeApp, /select_previous_save_slot/);
assert.match(runtimeApp, /select_next_save_slot/);
assert.match(runtimeApp, /Saved runtime state via/);
assert.match(runtimeApp, /Loaded runtime state via/);
assert.match(runtimeApp, /F8 to quicksave the active runtime save slot/);
assert.match(runtimeApp, /F11\/F12 to cycle runtime save slots/);
