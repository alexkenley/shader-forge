...
try {
  ...
  assert.match(sceneEditorView, /Unsaved changes are still here/);
  ...
  assert.match(sceneEditorView, /aria-label="Objects"/);
  ...
  assert.match(shellApp, /CMake is required for Build and Build \+ Run/);
