...
assert.match(inputSource, /SDL_SCANCODE_F8/);
assert.match(inputSource, /SDL_SCANCODE_F9/);
...
assert.match(runtimeApp, /actionPressed\("save_runtime_state"\)/);
assert.match(runtimeApp, /actionPressed\("load_runtime_state"\)/);
assert.match(runtimeApp, /actionPressed\("toggle_physics_debug"\)/);
assert.match(runtimeApp, /actionPressed\("select_previous_save_slot"\)/);
assert.match(runtimeApp, /actionPressed\("select_next_save_slot"\)/);
...
assert.match(actionsToml, /save_runtime_state/);
assert.match(actionsToml, /load_runtime_state/);
assert.match(actionsToml, /toggle_physics_debug/);
assert.match(actionsToml, /select_previous_save_slot/);
assert.match(actionsToml, /select_next_save_slot/);
...
assert.match(gameplayToml, /code = "f8"/);
assert.match(gameplayToml, /code = "f9"/);
assert.match(gameplayToml, /code = "f10"/);
assert.match(gameplayToml, /code = "f11"/);
assert.match(gameplayToml, /code = "f12"/);
