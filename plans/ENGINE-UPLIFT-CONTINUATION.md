...
- Continue migration beyond the new Unity/Godot text-scene hierarchy/transform and Unity perspective Camera mapping into Unity prefab instances/other components/orthographic and enabled-state semantics/coordinate remediation, Unreal hierarchy, asset/material/component/script conversion, Godot matrices/resource instances, conflict-safe reimport, provenance review, and exporter-assisted Unreal extraction.
