...
- Continue migration beyond the new Unity/Godot text-scene hierarchy/transform mapping into Unity prefab instances/components/coordinate remediation, Unreal hierarchy, asset/material/component/script conversion, Godot matrices/resource instances, conflict-safe reimport, provenance review, and exporter-assisted Unreal extraction.
