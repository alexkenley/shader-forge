...
21. next: transform authored joint/capsule/collision inputs into numeric diagnostics, then add native cameras/capture and immutable review packets before exposing typed MCP spatial read/validation/recapture/review adapters
