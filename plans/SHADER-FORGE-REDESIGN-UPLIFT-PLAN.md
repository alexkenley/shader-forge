...
20. next: add explicit item collision geometry and numeric joint-limit/capsule clipping diagnostics, then native cameras/capture and immutable review packets before exposing typed MCP spatial read/validation/recapture/review adapters
