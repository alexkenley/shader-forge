...
25. in progress: deterministic native close/player-camera capture, lease/revision-bound atomic sessiond review packets, thin CLI/MCP recapture/read adapters, and the typed MCP review resource are implemented; add shell review presentation
