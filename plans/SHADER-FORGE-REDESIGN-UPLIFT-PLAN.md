...
25. next: add recapture, revision-bound native frame capture from the authored camera plus deterministic close cameras, immutable review packets, and typed review adapters
