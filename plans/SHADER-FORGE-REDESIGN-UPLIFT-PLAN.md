...
25. in progress: deterministic native close/player-camera capture plus lease/revision-bound atomic sessiond review packets and reads are implemented; add thin CLI/MCP/shell review adapters and typed resources
