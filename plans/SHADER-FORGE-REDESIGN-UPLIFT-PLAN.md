...
23. next: add operation-scoped validation/recapture, revision-bound native frame capture from the authored camera plus deterministic close cameras, immutable review packets, and typed MCP validation/review adapters
