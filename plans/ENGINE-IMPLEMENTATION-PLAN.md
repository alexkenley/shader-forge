...
- Phase 5.9 has now started through `ai/providers.toml`, shared provider inspection/smoke-test code under `tools/shared/engine-ai-service.mjs`, optional Ollama plus OpenRouter/Kimi execution, `engine_sessiond` AI inspection/test routes, `engine ai providers|test|request`, a shell-side workspace AI status card, and `test:ai-scaffold`.
