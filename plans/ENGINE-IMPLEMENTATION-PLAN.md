...
Still ahead inside this phase:
- resumable queued requests, retry, and fallback behavior beyond the current process-scoped submit/status/cancel/event lifecycle and durable terminal metadata history
