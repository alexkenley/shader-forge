...
- Phase 5.73 has started with compatible v1 skeleton loading, strict v2 skeleton/socket and v1 attachment-profile validation, generation-safe query handles, isolated humanoid/weapon fixtures, deterministic native validation, an explicit atomic spatial cooker, a lease-gated semantic attachment preview operation, a strict sessiond-backed CLI adapter, and a constrained Assets tuner. Generic bake/runtime consumption, sampling, IK, rendering/capture/review packets, and MCP integration remain ahead.
