...
Status:
- native schema/query/cook/rest-schematic evaluation, compatible v1/strict v2 profiles, deterministic schema-v2 clip sampling and sampled two-bone IK, authored v2 cone-twist/capsule parse/cook, end-to-end diagnose-only joint-limit and capsule/item surface-clearance diagnostics, strict CLI queries, typed revision-bound MCP rest/sample reads, semantic attachment operations, and constrained Assets tuning implemented; generic bake/runtime consumption, runtime collision/physics integration, typed MCP validation/review resources, and rendered capture/review workflow deferred
