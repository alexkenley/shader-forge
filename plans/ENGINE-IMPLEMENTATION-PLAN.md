...
- broader runtime component simulation beyond the current controlled-entity transform loop, first authored-physics movement blocking, and first interaction-trigger feedback
