...
- Phase 6.2 has now started through a source-controlled export-preset lane, release-layout inspection plus packaging commands, packaged authored runtime roots alongside bundled cooked outputs, launch scripts, a real default ZIP hook, shell/sessiond packaging surfaces, and deterministic packaging coverage.
...
- Phase 6.2 continuation: widen the export/package foundation beyond its release layout and default ZIP into runtime-build orchestration, richer presets, installers/signing, and a real cooked-runtime release flow
