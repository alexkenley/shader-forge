...
- runtime inspection hooks for frame timing, input state, scene name, recent log capture, and first live gameplay-state context such as player id, movement speed, animation state, movement blocking, interaction target, and physics-debug state
