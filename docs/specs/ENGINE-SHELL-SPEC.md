...
- the `Workspace` right-panel tab now also exposes the active code-trust policy summary, supported authored hot-reload roots, and recent tracked trust artifacts for the selected workspace
