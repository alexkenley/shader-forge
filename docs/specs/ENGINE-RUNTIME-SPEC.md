...
- spatial authoring still needs a later sampling/IK/capture path in this native process; the current validator is one short-lived executable and does not add a daemon
