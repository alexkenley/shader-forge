...
- art assets, materials, animation, audio, Unity prefab instances/other components/camera and collider enabled state/orthographic cameras/trigger-layer-material collider semantics/coordinate-system remediation, Unreal hierarchy extraction, Godot transform matrices/resource instances/component payloads, exported Unreal actor data, and real exporter-manifest ingestion are still ahead
