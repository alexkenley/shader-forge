...
- CPU-side debug-proxy projection from the selected root or parented `player_camera`'s composed transform and strict authored perspective FOV/near/far values, with the ordinary runtime's legacy 70/0.15/1000 fallback when no camera component is authored
