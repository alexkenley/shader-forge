...
4. The evaluator resolves prefab render procgeo through `DataFoundation`; the animation loader still does not own or duplicate that catalogue. Joint limits, diagnostic capsules, and collision geometry remain deferred.
