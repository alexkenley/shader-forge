...
- Spatial authoring still needs generic bake/runtime consumption, runtime collision/physics integration, attachment rendering and revision-bound native frame capture, validate/recapture/review-packet operations, and typed MCP validation/review tools beyond the implemented revision-bound `spatial_attachment_read`, attachment mutation adapter, joint-limit diagnostics, capsule/item surface-clearance diagnostics, and authored runtime camera.
