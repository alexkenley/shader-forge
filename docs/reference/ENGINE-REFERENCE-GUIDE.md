...
- `content/procgeo/*.procgeo.toml` is the initial authored procedural-geometry lane; dimensions require complete unquoted finite positive float32 numbers, and plane-grid row/column counts require complete decimal integers.
